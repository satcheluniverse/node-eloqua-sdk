...
class ActivitiesFields {
  ...
  get(querystring, cb) {
    ...
    if (querystring) {
      qs = _classPrivateFieldLooseBase(this, _parent)[_parent]._validate(['activityType', 'limit', 'links', 'offset', 'orderBy', 'q', 'totalResults'], querystring);
    }
...
exports.default = ActivitiesFields;
