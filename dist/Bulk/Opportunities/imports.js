...
class OpportunitiesImports {
  ...
  create(opportunitiesImport, cb) {
    const data = _classPrivateFieldLooseBase(this, _parent)[_parent]._validate(['autoDeleteDuration', 'createdAt', 'createdBy', 'dataRetentionDuration', 'fields', 'identifierFieldName', 'importPriorityUri', 'isSyncTriggeredOnImport', 'isUpdatingMultipleMatchedRecords', 'kbUsed', 'name', 'nullIdentifierFieldName', 'updatedAt', 'updatedBy', 'updateRule', 'uri'], opportunitiesImport);
...
exports.default = OpportunitiesImports;
