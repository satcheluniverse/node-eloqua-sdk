...
class CampaignResponsesExports {
  ...
  create(campaignResponseExport, cb) {
    const data = _classPrivateFieldLooseBase(this, _parent)[_parent]._validate(['areSystemTimestampsInUTC', 'autoDeleteDuration', 'createdAt', 'createdBy', 'dataRetentionDuration', 'fields', 'filter', 'kbUsed', 'maxRecords', 'name', 'updatedAt', 'updatedBy', 'uri'], campaignResponseExport);
...
exports.default = CampaignResponsesExports;
