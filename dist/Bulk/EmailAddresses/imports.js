...
class EmailAddressesImports {
  ...
  create(emailAddressesImport, cb) {
    const data = _classPrivateFieldLooseBase(this, _parent)[_parent]._validate(['autoDeleteDuration', 'createdAt', 'createdBy', 'dataRetentionDuration', 'fields', 'identifierFieldName', 'importPriorityUri', 'isSyncTriggeredOnImport', 'isUpdatingMultipleMatchedRecords', 'kbUsed', 'name', 'nullIdentifierFieldName', 'syncActions', 'updatedAt', 'updatedBy', 'updateRule', 'uri'], emailAddressesImport);
...
exports.default = EmailAddressesImports;
