...
class OptionLists {
  ...
  create(optionList, cb) {
    const data = _classPrivateFieldLooseBase(this, _parent)[_parent]._validate(['accessedAt', 'createdAt', 'createdBy', 'currentStatus', 'depth', 'description', 'elements', 'id', 'name', 'permissions', 'type', 'updatedAt', 'updatedBy'], optionList);
...
exports.default = OptionLists;

var _parent = _classPrivateFieldLooseKey("parent");

module.exports = exports.default;
//# sourceMappingURL=optionLists.js.map
