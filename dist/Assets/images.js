...
class Images {
  ...
  update(id, imageFile, cb) {
    const data = _classPrivateFieldLooseBase(this, _parent)[_parent]._validate(['accessedAt', 'createdAt', 'createdBy', 'currentStatus', 'depth', 'description', 'folderId', 'fullImageUrl', 'id', 'link', 'name', 'permissions', 'scheduledFor', 'size', 'source', 'sourceTemplateId', 'syncDate', 'thumbnailUrl', 'type', 'updatedAt', 'updatedBy'], imageFile);
