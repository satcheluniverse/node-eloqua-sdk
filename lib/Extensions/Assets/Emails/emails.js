...
class Emails {
  ...
  async create(email) {
    let data = this._parent._validate(
      [
        'accessedAt', 'archive', 'attachments', 'bounceBackEmail', 'contentSections',
        'contentServiceInstances', 'createdAt', 'createdBy', 'currentStatus', 'depth', 'description',
        'dynamicContents', 'emailFooterId', 'emailGroupId', 'emailHeaderId', 'encodingId', 'fieldMerges',
        'files', 'folderId', 'forms', 'htmlContent', 'hyperlinks', 'id', 'images', 'isContentProtected',
        'isPlainTextEditable', 'isPrivate', 'isTracked', 'layout', 'name', 'permissions', 'plainText',
        'renderMode', 'replyToEmail', 'replyToName', 'scheduledFor', 'senderEmail', 'senderName',
        'sendPlainTextOnly', 'sourceTemplateId', 'style', 'subject', 'type', 'updatedAt', 'updatedBy',
        'virtualMTAId'
      ],
      email);
