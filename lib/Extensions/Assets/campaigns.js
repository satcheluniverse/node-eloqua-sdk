...
class Campaigns {
  ...
  async create(campaign) {
    let data = this._parent._validate(
      [
        'accessedAt', 'actualCost', 'badgeId', 'budgetedCost', 'campaignCategory', 'campaignType',
        'clrEndDate', 'createdAt', 'createdBy', 'crmId', 'currentStatus', 'depth', 'description',
        'elements', 'endAt', 'fieldValues', 'firstActivation', 'folderId', 'id',
        'isEmailMarketingCampaign', 'isIncludedInROI', 'isMemberAllowedReEntry', 'isReadOnly',
        'isSyncedWithCRM', 'memberCount', 'name', 'permissions', 'product', 'region', 'runAsUserId',
        'scheduledFor', 'sourceTemplateId', 'startAt', 'type', 'updatedAt', 'updatedBy'
      ],
      campaign);
