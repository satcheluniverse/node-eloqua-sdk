 ...
 */
let ContactActivities = require('./contactActivities');
...
class Contacts {
  ...
  constructor(options) {
    ...
    this.activities = new ContactActivities(this._parent);
  }
  ...
  async create(contact) {
    let data = this._parent._validate(
      [
        'accessedAt', 'accountId', 'accountname', 'address1', 'address2', 'address3', 'bouncebackDate',
        'businessPhone', 'city', 'country', 'createdAt', 'createdBy', 'currentStatus', 'depth',
        'description', 'emailAddress', 'emailFormatPreference', 'fax', 'fieldValues', 'firstName', 'id',
        'isBounceback', 'isSubscribed', 'lastName', 'mobilePhone', 'name', 'permissions', 'postalCode',
        'province', 'salesPerson', 'subscriptionDate', 'title', 'type', 'unsubscriptionDate', 'updatedAt',
        'updatedBy'
      ],
      contact);
