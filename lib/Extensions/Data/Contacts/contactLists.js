...
class ContactLists {
  ...
  async create(contactList) {
    let data = this._parent._validate(
      [
        'accessedAt', 'count', 'createdAt', 'createdBy', 'currentStatus', 'dataLookupId', 'depth',
        'description', 'id', 'membershipAdditions', 'membershipDeletions', 'name', 'permissions', 'scope',
        'type', 'updatedAt', 'updatedBy'
      ],
      contactList);
