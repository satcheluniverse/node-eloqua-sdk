...
class Accounts {
  ...
  async create(account) {
    let data = this._parent._validate(
      [
        'accessedAt', 'address1', 'address2', 'address3', 'businessPhone', 'city', 'country', 'createdAt',
        'createdBy', 'currentStatus', 'depth', 'description', 'fieldValues', 'id', 'name', 'permissions',
        'postalCode', 'province', 'type', 'updatedAt', 'updatedBy'
      ],
      account);
