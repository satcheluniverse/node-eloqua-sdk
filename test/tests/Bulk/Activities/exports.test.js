    ...
    eloqua
      ...
      .then(() => {
        eloqua.bulk.activities.exports.get({ limit: 1 }).then(results => {
          ...
          eloqua.bulk.activities.exports
            .getOne(results.items[0].uri.replace('/activities/exports/', ''))
            .then(result => {
              expect(result).to.be.an('Object');
            });
        });
    ...
    eloqua
      ...
      .then(() => {
        eloqua.bulk.activities.exports.get({ limit: 1 }).then(results => {
          expect(results).to.be.an('Object');
          eloqua.bulk.activities.exports
            .getData(results.items[0].uri.replace('/activities/exports/', ''))
            .then(result => {
              expect(result).to.be.an('Object');
            });
        });
    ...
    eloqua
      ...
      .then(() => {
        eloqua.bulk.activities.exports.get({ limit: 1 }).then(results => {
          expect(results).to.be.an('Object');
          eloqua.bulk.activities.exports
            .getData(results.items[0].uri.replace('/activities/exports/', ''), { limit: 1 })
            .then(result => {
              expect(result).to.be.an('Object');
            });
        });
