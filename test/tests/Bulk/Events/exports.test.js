...
describe('Event Export Tests', () => {
  ...
  it('Event Export Get One', done => {
    ...
    eloqua.init().then(() => {
      eloqua.bulk.events.exports.get(parentId, {limit: 1}).then((results) => {
        ...
        eloqua.bulk.events.exports.getOne(parentId, results.items[0].uri.replace(`/events/${parentId}/exports/`,'')).then((result) => {
          expect(result).to.be.an('Object');
        });
      });
    }).then(done);
  ...
  it('Event Export Get Data', (done) => {
    ...
    eloqua.init().then(() => {
      eloqua.bulk.events.exports.get(parentId,{limit: 1}).then((results) => {
        expect(results).to.be.an('Object');
        eloqua.bulk.events.exports.getData(parentId, results.items[0].uri.replace(`/events/${parentId}/exports/`,'')).then((result) => {
          expect(result).to.be.an('Object');
        });
      });
    }).then(done);
  ...
  it('Event Export Get Data with Querystring', (done) => {
    ...
    eloqua.init().then(() => {
      eloqua.bulk.events.exports.get(parentId, {limit: 1}).then((results) => {
        expect(results).to.be.an('Object');
        eloqua.bulk.events.exports.getData(parentId, results.items[0].uri.replace(`/events/${parentId}/exports/`,''), {limit: 1}).then((result) => {
          expect(result).to.be.an('Object');
        });
      });
    }).then(done);
