...
describe('Campaign Responses Export Tests', () => {
  ...
  it.skip('Campaign Responses Export Get One', done => {
    ...
    eloqua.init().then(() => {
      eloqua.bulk.campaignResponses.exports.get({limit: 1}).then((results) => {
        ...
        eloqua.bulk.campaignResponses.exports.getOne(results.items[0].uri.replace('/campaignResponses/exports/','')).then((result) => {
          expect(result).to.be.an('Object');
        });
      });
    }).then(done);
  ...
  it.skip('Campaign Responses Export Get Data', (done) => {
    ...
    eloqua.init().then(() => {
      eloqua.bulk.campaignResponses.exports.get({limit: 1}).then((results) => {
        expect(results).to.be.an('Object');
        eloqua.bulk.campaignResponses.exports.getData(results.items[0].uri.replace('/campaignResponses/exports/','')).then((result) => {
          expect(result).to.be.an('Object');
        });
      });
    }).then(done);
  ...
  it.skip('Campaign Responses Export Get Data with Querystring', (done) => {
    ...
    eloqua.init().then(() => {
      eloqua.bulk.campaignResponses.exports.get({limit: 1}).then((results) => {
        expect(results).to.be.an('Object');
        eloqua.bulk.campaignResponses.exports.getData(results.items[0].uri.replace('/campaignResponses/exports/',''), {limit: 1}).then((result) => {
          expect(result).to.be.an('Object');
        });
      });
    }).then(done);
