    ...
    eloqua
      ...
      .then(() => {
        eloqua.bulk.customObjects.exports.get(parentId, { limit: 1 }).then(results => {
          ...
          eloqua.bulk.customObjects.exports
            .getOne(parentId, results.items[0].uri.replace(`/customObjects/${parentId}/exports/`, ''))
            .then(result => {
              expect(result).to.be.an('Object');
            });
        });
    ...
    eloqua
      ...
      .then(() => {
        eloqua.bulk.customObjects.exports.get(parentId, { limit: 1 }).then(results => {
          expect(results).to.be.an('Object');
          eloqua.bulk.customObjects.exports
            .getData(parentId, results.items[0].uri.replace(`/customObjects/${parentId}/exports/`, ''))
            .then(result => {
              expect(result).to.be.an('Object');
            });
        });
    ...
    eloqua
      ...
      .then(() => {
        eloqua.bulk.customObjects.exports.get(parentId, { limit: 1 }).then(results => {
          expect(results).to.be.an('Object');
          eloqua.bulk.customObjects.exports
            .getData(parentId, results.items[0].uri.replace(`/customObjects/${parentId}/exports/`, ''), { limit: 1 })
            .then(result => {
              expect(result).to.be.an('Object');
            });
        });
