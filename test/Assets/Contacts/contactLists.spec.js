...
describe('Contact List Tests', () => {
  ...
  it('Contact List Get', done => {
    ...
    eloqua.assets.contacts.lists.get(null, assertSuccessful(done, function(err, result, xhr) {
  ...
  it('Contact List Get with Querystring', done => {
    ...
    eloqua.assets.contacts.lists.get({count: 1}, assertSuccessful(done, function(err, result, xhr) {
      expect(xhr.config.url).to.eql('https://secure.p01.eloqua.com/API/REST/2.0/assets/contact/lists');
  ...
  it('Contact List Get One', done => {
    ...
    eloqua.assets.contacts.lists.getOne(1, null, assertSuccessful(done, function(err, result, xhr) {
  ...
  it('Contact List Get One with Querystring', done => {
    ...
    eloqua.assets.contacts.lists.getOne(1, {depth: 'minimal'}, assertSuccessful(done, function(err, result, xhr) {
      expect(xhr.config.url).to.eql('https://secure.p01.eloqua.com/API/REST/2.0/assets/contact/list/1');
  ...
  it('Contact List Create', done => {
    ...
    eloqua.assets.contacts.lists.create(data, assertSuccessful(done, function(err, result, xhr) {
  ...
  it('Contact List Update', done => {
    ...
    eloqua.assets.contacts.lists.update(1, data, assertSuccessful(done, function(err, result, xhr) {
      expect(xhr.config.url).to.eql('https://secure.p01.eloqua.com/API/REST/2.0/assets/contact/list/1');
  ...
  it('Contact List Delete', done => {
    ...
    eloqua.assets.contacts.lists.delete(1, assertSuccessful(done, function(err, result, xhr) {
      expect(xhr.config.url).to.eql('https://secure.p01.eloqua.com/API/REST/2.0/assets/contact/list/1');
